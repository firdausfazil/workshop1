...
<html lang="en">
  ...
  <body>
	...
	<button type="submit" class="btn btn-block btn-lg btn-primary" name="updatebarber">update</button> <br>
	 <button type="submit" class="btn btn-block btn-lg btn-primary" name="deletebarber">Delete</button> <br>
