...
<html lang="en">
  ...
  <body>
	...
	<button type="submit" class="btn btn-block btn-lg btn-primary" name="updateuser">update</button> <br>
	<button type="submit" class="btn btn-block btn-lg btn-primary" name="deleteuser">Delete</button> <br>
