  ...
  <body>
	...
	<br><br>
        ...
        <fieldset>
          ...
          <input type="text" id="name" name="barber_name">
          
          <label for="mail">Email:</label>
          <input type="email" id="mail" name="barber_email" placeholder="<?= $email ?>" value="<?= $email ?>">
          
          <label for="password">Password:</label>
          <input type="password" id="password" name="barber_password">
		  
		  <label for="phonum">Phone Number:</label>
          <input type="text" id="name" name="barber_num">
        </fieldset>
        
        <fieldset>
          <legend><span class="number">2</span>Your Location</legend>
          <label for="address">Address:</label>
          <input type="text" id="address" name="barber_address">
		  
		  <label for="city">City:</label>
          <input type="text" id="city" name="barber_city">
		  
		  <label for="zip">ZIP Code:</label>
          <input type="text" id="zip" name="barber_zipcode">
		  
		  <label for="country">Country:</label>
		  <select id="contry" name="barber_country">
		...
		<legend><span class="number">3</span>Company</legend>
          ...
          <input type="text" id="name" name="barber_cname">
        ...
        <button type="submit" name="barbersignup">Sign Up</button>
      </form>
